...
const FanLaunchTokenAllocation = () => {
    return (
        <div className="text-white sm:px-30 lg:px-50">
            <h1 className="text-center font-bold text-xl sm:text-2xl md:text-3xl xl:4xl">Fan Launch and Token Allocation<sup className="text-xs sm:text-lg">150 billion</sup></h1>

            <h2 className="sm:text-xl md:text-2xl font-bold mt-5">IMPORTANT Notice [Fan Event]: </h2>
            <ol className="list-decimal ml-2  text-sm sm:text-lg xl:text-2xl mt-5 sm:mt-10 flex flex-col gap-3">
            ...
            <h2 className="sm:text-xl md:text-2xl font-bold mt-5">Conditions:</h2>
            <ul className="list-disc ml-2  text-sm sm:text-lg xl:text-2xl mt-5 sm:mt-10 flex flex-col gap-3">
            ...
            <h2 className="sm:text-xl md:text-2xl font-bold mt-5">How to participate in the $LMAO Fan Launch: </h2>
            <ol className="list-decimal ml-2  text-sm sm:text-lg xl:text-2xl mt-5 sm:mt-10 flex flex-col gap-3">
